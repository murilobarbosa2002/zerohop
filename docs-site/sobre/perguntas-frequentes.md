...
Não. Não existe conta, login, e-mail ou qualquer identificação além do nome que você digita (e que só serve para os outros participantes te reconhecerem na sala).
...
Na maioria dos casos é um antivírus ou uma rede restritiva bloqueando o tráfego direto. Veja o passo a passo em [Solução de problemas](/seguranca/solucao-de-problemas).

## Por que não existe um servidor de "backup" (TURN) para quando a conexão direta falha?

Porque é uma decisão deliberada do projeto: nenhum servidor de relay gratuito viável oferece banda suficiente para vídeo de forma confiável, e a alternativa de usar um pago contradiz o princípio de ser um projeto sem custo e sem intermediário. Veja [Sem servidor, sem TURN](/seguranca/sem-servidor-sem-turn).

## Funciona em outros sistemas operacionais além do Windows?

O instalador oficial distribuído nas Releases é para Windows. Como o código é aberto, é possível compilar o projeto em outros sistemas, mas isso não é testado nem oficialmente suportado no momento.
