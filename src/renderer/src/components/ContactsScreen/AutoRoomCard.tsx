...
import { playInviteContactToggleSound } from '@/services/soundEffects';
...
export function AutoRoomCard({ id, password, onChangePassword, contacts, inviteContactIds, onToggleInviteContact }: AutoRoomCardProps) {
  return (
    <Card muted>
