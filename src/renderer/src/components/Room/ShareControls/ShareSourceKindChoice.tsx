...
import { playShareKindFullscreenSound, playShareKindWindowSound } from '@/services/soundEffects';
  ...
  return (
    <div className="flex gap-3 flex-wrap">
      <ActionButton
        ...
        onClick={() => {
          playShareKindFullscreenSound();
          onSelect(CaptureSourceKind.SCREEN);
        }}
      >
      ...
      <ActionButton
        ...
        className="flex-1 min-w-form-column"
        onClick={() => {
          playShareKindWindowSound();
          onSelect(CaptureSourceKind.WINDOW);
        }}
      >
