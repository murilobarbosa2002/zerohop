...
export const actionButtonVariants = tv({
  base: 'px-4 py-2.5 mr-1 my-1 rounded-button text-body-sm font-semibold border transition-colors active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed',
  variants: {
    variant: {
