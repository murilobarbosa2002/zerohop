...
export function playNotificationReadSound(): void {
  play(notificationReadSound, SoundCategory.INTERFACE);
}

export function playDeleteNotificationOpenSound(): void {
  play(deleteNotificationOpenSound, SoundCategory.INTERFACE);
}

export function playDeleteNotificationConfirmSound(): void {
  play(deleteNotificationConfirmSound, SoundCategory.INTERFACE);
}

export function playSwitchRoomSound(): void {
  play(switchRoomSound, SoundCategory.ROOM);
}
